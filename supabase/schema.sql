-- ============================================================================
-- GritDocs Supabase Schema - Complete Database Setup
...
CREATE TABLE IF NOT EXISTS public.user_profiles (
  ...
  business_type INTEGER DEFAULT 2,
  logo_url TEXT,
  website TEXT,
  phone TEXT,
  address TEXT,
...
-- ============================================================================
-- 5. DOCUMENTS TABLE (Invoices, Contracts, HR Docs)
-- ============================================================================
...
-- ============================================================================
-- 7. PUBLIC SHARE TOKENS TABLE (for shareable invoice links)
-- ============================================================================
...
-- ============================================================================
-- 8. AUDIT LOGS TABLE (for compliance & security tracking)
-- ============================================================================
...
-- ============================================================================
-- 9. ANALYTICS EVENTS TABLE (for usage tracking & insights)
-- ============================================================================
...
-- ============================================================================
-- 10. FEATURE FLAGS TABLE (for A/B testing & feature rollouts)
-- ============================================================================
...
-- ============================================================================
-- 11. ITEM USAGE TABLE (track which items are used most frequently)
-- ============================================================================
...
-- template_items: inherit from template via foreign key
CREATE POLICY "users_select_own_template_items" ON public.template_items
  FOR SELECT USING (
    template_id IN (
      SELECT id FROM public.templates WHERE user_id = auth.uid()
    )
  );
...
-- invoice_items: inherit from document via foreign key
...
-- public_share_tokens: users can see their own tokens
...
-- public access for valid tokens (for public invoice viewing)
...
-- audit_logs: users can see their own logs, admins can see all
...
-- item_usage: users can see their own
...
-- ============================================================================
-- COMMENTS (for documentation in Supabase Studio)
-- ============================================================================
